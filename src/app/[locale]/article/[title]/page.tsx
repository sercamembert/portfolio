  ...
  return (
    <>
      <div className="blog-padding flex flex-col mb-[100px] mt-[100px] min-h-screen">
        ...
        <p className="text-[9px] md:text-[12px] lg:text-[16px] xl:text-[20px] 2xl:text-[23px] 3xl:text-[25px] desktop:text-[28px] opacity-80">
          {post.entryText}
        </p>
        <Image
        ...
        <p
          className="opacity-80 text-[9px] md:text-[12px] lg:text-[16px] xl:text-[20px] 2xl:text-[23px] 3xl:text-[25px] desktop:text-[28px]
