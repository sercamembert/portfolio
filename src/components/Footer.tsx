...
const Footer = ({
  ...
  return (
    <div
      className="flex mt-[22px] md:mt-[66px] lg:mt-[79px] desktop:mt-[97px]
        border-t border-footer w-full h-[141.93px] md:h-[290.67px] lg:h-[387.56px] xl:h-[506px] 2xl:h-[545px] 3xl:h-[582.09px] desktop:h-[650.97px]
    ...
    >
      ...
      >
        ...
        <div className="flex gap-[3px] md:gap-[6px] mt-[7px] md:mt-[15px] lg:mt-[19px] xl:mt-[26px] 2xl:mt-[28px] 3xl:mt-[30px] desktop:mt-[33px]">
          <p className="font-medium text-[5.5px] md:text-[11.26px] lg:text-[15.02px] xl:text-[18.77px] 2xl:text-[21.12px] 3xl:text-[22.56px] desktop:text-[25.23px]">
      ...
      "
        >
          <div className="flex flex-col gap-y-[3px] md:gap-y-[6px] lg:gap-y-[10px] xl:gap-y-[12px] 2xl:gap-y-[13px] 3xl:gap-y-[14px] desktop:gap-y-[20px]">
            <h1 className="font-bold text-[6.6px] md:text-[13.51px] lg:text-[18.02px] xl:text-[22.52px] 2xl:text-[25.34px] 3xl:text-[27.06px] desktop:text-[30px]">
              {services}
            </h1>
            <p className="font-medium text-[5.5px] md:text-[11.26px] lg:text-[15.02px] xl:text-[18.77px] 2xl:text-[21.12px] 3xl:text-[22.56px] desktop:text-[25.23px]">
        ...
        <div
          ...
          pb-[12px] md:pb-[27px] lg:pb-[35px] xl:pb-[45px] 2xl:pb-[49px] 3xl:pb-[52px] desktop:pb-[59px]
          pr-[17.4%]
        "
        >
          <p className="text-[3.82px] md:text-[7.82px] lg:text-[10.43px] xl:text-[13.04px] 2xl:text-[14.67px] 3xl:text-[15.67px] desktop:text-[17.52px]">
            {terms}
          </p>
          <p className="text-[3.82px] md:text-[7.82px] lg:text-[10.43px] xl:text-[13.04px] 2xl:text-[14.67px] 3xl:text-[15.67px] desktop:text-[17.52px]">
            {privacy}
