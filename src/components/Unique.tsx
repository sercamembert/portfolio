...
const Unique = ({
  ...
  return (
    <div className="padding flex flex-col w-full gap-[7px] mt-[90px] md:mt-[112px] lg:mt-[201px] xl:mt-[257px] 2xl:mt-[360px] 3xl:mt-[300px] ">
      ...
      <div
        className="flex flex-col md:flex-row md:min-h-[362.5px] lg:min-h-[468.86px] xl:min-h-[598.2px] 3xl:min-h-[699.52px] desktop:mih-h-[766.15px]
        unigapx unigapy
      "
      >
        <div
          className="flex flex-col md:w-[55.4%] md:min-h-[362.5px] lg:min-h-[468.86px] xl:min-h-[598.2px] 3xl:min-h-[699.52px] desktop:mih-h-[766.15px]
          unigapy
        "
        >
          <div
            className="flex flex-col md:flex-row md:h-1/2 unigapy unigapx items-center
          "
          >
            <div
              style={{
        ...
        >
          <h1
            className="w-full text-center font-extrabold text-[30px] mb-[4px] break-words md:text-[72.2px] lg:text-[93.38px] xl:text-[119.14px] 3xl:text-[139.32px] desktop:text-[152.59px] leading-[1]
